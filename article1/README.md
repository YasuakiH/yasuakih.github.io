...
### 未知パラメータ
顧客の使い方を特徴付ける情報を、外部から観察できない意味で「未知パラメータ」と呼ぶ。これには物理的な用紙サイズ・印刷ページ数・両面片面の別、原稿を特徴づけるインク塗布量、また印刷機が生産財を出力する点では顧客固有の品質基準などが含まれる。モンテカルロ法は、このような未知パラメータを推定するコンピューターの応用である。
