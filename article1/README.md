...
### 未知パラメータ仮定
#### 印刷機セグメント
印刷機セグメントは、印刷機の使われ方を二次元マップ上の位置で表すものである。Y軸, X軸はそれぞれ、トータルエリアカバレッジと印刷ジョブ長である。モンテカルロ・シミュレーションでは9つある印刷機セグメントから1つを無作為に選択した。これによってトータルエリアカバレッジと印刷ジョブ長も決まる。2つのパラメータの大きさはマップ上の位置で直感的に把握できる。

* ![モデリング-印刷機セグメントの二次元マップ.png](img/モデリング-印刷機セグメントの二次元マップ.png)
  *印刷機の使われ方を説明する印刷機セグメントの二次元マップ。桃色で示す位置は、トータルエリアカバレッジ=Mid、印刷ジョブ長=Loに対応する。*

* ![モデリング-印刷機セグメントの二次元マップ.png](img/モデリング-印刷機セグメントの二次元マップ.png) *印刷機の使われ方を説明する印刷機セグメントの二次元マップ。桃色で示す位置は、トータルエリアカバレッジ=Mid、印刷ジョブ長=Loに対応する。*
...
### Step1. 印刷ジョブのモデリング
#### 未知パラメータ
またシミュレーションを簡単にするために、それぞれのパラメータを3段階 (Lo, Hi, Mid) の離散的な値とし、二次元マップを9つの領域 (3 x 3) に分割した。それぞれの領域には便宜上、図のような Q1-Q9 の9つのアドレスを割り当てた。1つのアドレスの指定と、2つのパラメータの指定は同等である。シミュレーションでは未知パラメータを仮定するためにアドレス Q1-Q9 を無作為に選択した。
