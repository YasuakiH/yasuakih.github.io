...
## 未知パラメータと推定
### 部品ライフ管理の最適化と未知パラメータ
部品ライフは印刷機にかかる負荷によって左右される。部品の保守管理を最適化するために、顧客がどのように印刷機を使用し、どのような負荷が部品にかかるかを知る必要がある。その有力な情報源である印刷ジョブは、前述のように外部から知ることができない。そこで、入手できる情報をもとに部品ライフを表す別の指標を策定することとなる。こうした印刷業者の使い方を特徴づける情報を、外部から観測できないという意味で「未知パラメータ」と呼ぶ。
