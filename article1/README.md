...
#### 用紙サイズ比率
多数ある用紙サイズのうち、印刷機によって得手不得手があると考えられる。未知パラメータとして、使用する用紙サイズの種類を候補群 (葉書, A4, B4, A3, 長尺 5種類) から無作為に 3-4種類を選択した。
...
#### 用紙サイズ比率
その印刷機が利用可能な用紙サイズから、それぞれのサイズの合計が100%になるように、ランダムに配分を決めた。
