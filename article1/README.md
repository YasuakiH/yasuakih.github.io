...
## 環境と構成要素
### デジタル印刷機
デジタル印刷機はオンデマンド印刷に用いられ、その性能を維持するためにドラム、ブレード、ベルトなどの消耗品を定期的に交換する必要がある。メーカーは、定期交換部品ごとに寿命の管理目標を設定し、計画的に交換することで印刷機の故障を未然に防ぐ保守サービスを提供している。高い信頼性が求められる印刷機は、通信ネットワークを介して稼働状況を送信する機能を持つ。メーカーは、印刷業者 (顧客) の送られた稼働状況を用いて機械の状態を把握することができる。
...
### 未知パラメータ
この記事では、顧客の使い方を特徴付ける印刷ジョブなどの情報を、外部から観察できない意味で「未知パラメータ」と呼ぶ。これには物理的な用紙サイズ・印刷ページ数・両面片面の別、原稿を特徴づけるインク塗布量、また印刷機が生産財を出力する点では顧客固有の品質基準などが含まれる。モンテカルロ法は、このような未知パラメータを推定するコンピューターの応用である。
