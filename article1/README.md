...
<div align="center">
<figure>
  <img src="img/設計-印刷ジョブ生成-用紙サイズサンプリング.png" width="90%"/>
  <br/>
...
<div align="center">
<figure>
  <img src="img/設計-印刷ジョブ生成-トータルエリアカバレッジサンプリング.png" width="90%"/>
  <br/>
...
#### 評価0: インク量 (累積)
総インク量は印刷ジョブごとの消費インク量を累積して算出し、シミュレーションを終了する条件として用いている。したがって期待値と推定値はほぼ一致するはずである。

<div align="center">
<figure>
  <img src="img/妥当性評価-資源消費量-インク.png"/>
  <br/>
  <figcaption>図. 妥当性評価-資源消費量-インク.png</figcaption>
</figure>
</div>
