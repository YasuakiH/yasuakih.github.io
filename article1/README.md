...
<figure>
  ...
  <br/>
  <figcaption>図11. ページ長分布を示す。上側は期待値、下側はシミュレーション値。用紙サイズによって分布が異なり、それらが重なって複数のピークを持った形状をしている。下側のシミュレーション結果では、用紙サイズで色別することで区間ごとの内訳がわかる。交差エントロピー h2_ce = 3.27 bit</figcaption>
</figure>
</div>
