...
管理目標を増加させる、すなわち交換時期を遅らせることに伴い、トータルの部品交換数は低下した (下図を参照)。交換理由の内訳では、当初は「予防保守」(水色) が次第に減って、「障害故障」(桃色) が増加の一途をたどった。
...
上と同様、管理目標を増加させることで「予防保守」(水色) が次第に減り、「障害故障」(桃色) が増加する傾向である。それぞれの停止時間は、予防保守が30分で固定、障害故障が60-90分とペナルティが加わることから、トータルの停止時間には大きな変化は見られなかった。

顧客である印刷業者の立場では、「障害故障」(桃色) の発生は、計画外の印刷機の停止を引き起こし、修理が終わるまで業務を止めるために少ない方が望ましい。前述したように、エンジニアの確保においても同様である。
