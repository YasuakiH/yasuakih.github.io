...
#### ④管理目標値の最適値を探索
このステップでは、管理目標によって交換部品数や所要時間に与える影響をグラフィックで可視化する。上記①～③のステップで得る交換部品数や所要時間は確率的であるため、所定の回数だけ繰り返してその算術平均を採用した。交換時期の管理目標値の範囲を事前に設定し、それぞれの管理目標値について交換部品数や所要時間を算出し、グラフィックで可視化した。
