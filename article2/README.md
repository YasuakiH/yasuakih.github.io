...
| オプション | 意味 | 指定 |
| --- | --- | --- |
| --designed_life 1000000 | 部品ライフ設計値 | 1000k [A4短辺ページ] |
| --maxt 60*24*30*12 | シミュレーション期間 | 360 日 |
| --beta 1.8 | 母集団における部品ライフのワイブル分布形状パラメータ | 1.8 |
| --wearout_rate 0.5 0.6 0.7 0.8 0.9 1.0 1.1 1.2 1.3 1.4 1.5 | 予防保守の管理目標(係数) | |
| --iter 20 | シミュレーション回数 | 20 |
