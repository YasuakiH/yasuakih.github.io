...
### 詳細な構造
#### ①未知パラメータから部品負荷の推定
最初の記事で推定した<a href="../article1/#未知パラメータ">未知パラメータ</a>をもとに、部品にかかる負荷を推定するための印刷ジョブを生成する。本スタディでは、算出が容易で視覚的に理解しやすい搬送系の部品 (物理的な輸送を担う) に着目し、部品にかかる負荷は、印刷ジョブによって運動する用紙の搬送距離として見積もった。
