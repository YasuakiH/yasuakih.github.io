...
### 印刷機保守のシミュレーションモデル
デジタル印刷機に関連するさまざまな事象 － 印刷ジョブの生成と印刷、定期交換部品の経年と故障発生、エンジニアによる保守サービスの実行 － を表現し、コンピューターでシミュレートするためにシミュレーションモデルを作成した。シミュレーションモデルは前述した故障モデルを実行するために、リソース、プロセス、データといったオブジェクトを含む。主なものを次に示す。
