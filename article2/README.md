...
## 部品の故障モデル
本スタディでは、顧客による<a href="../article1/">印刷機の使われ方</a>が部品ライフに影響を及ぼすと考え、両者の関係を説明するために [応力-強度モデル](https://en.wikipedia.org/wiki/Stress%E2%80%93strength_analysis) (Stress–strength model) を使用した。
