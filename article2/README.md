...
## 部品ライフの推定方法
保守サービスにおける課題の一つに、サービス提供に要するコストと顧客が受け取るサービス品質との両立がある。顧客による<a href="../article1/">印刷機の使われ方</a>が部品ライフに影響を及ぼすと仮定した場合、サービス提供者の関心は、サービス品質に直結するパラメータ「定期交換部品の交換時期」の妥当性に向けられる。このパラメータ (交換時期) を変化させたとき、サービス提供に要するコストへの影響と、顧客に生じるリスクへの影響を予測することが求められる。一つ一つの部品ライフをシミュレートすることで、部品の交換数 (コスト) と印刷機の停止時間 (ダウンタイム) を予測できる。
