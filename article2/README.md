...
### 分かっているもの
#### 強度
部品の強度は保守サービスを介して得られる。また、交換した理由が故障なのか、それとも予防保守によるものかの区別もできる。
「修理しない」部品の場合、一般にワイブル分布が用いられる。2パラメータのワイブル分布では、特徴付けられる。
市場投入されてまもないシステムや高信頼性システムの場合、故障例が発生しておらず、稼働時間のみしか知られ
