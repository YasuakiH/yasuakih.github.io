...
<dl>
  ...
  <dt>③応力-強度モデル図作成</dt>
  <dd>機能②で作成した部品の交換履歴を入力して、特定の印刷機における応力 S を<a href="https://ja.wikipedia.org/wiki/%E5%AF%BE%E6%95%B0%E6%AD%A3%E8%A6%8F%E5%88%86%E5%B8%83">対数正規分布</a>で近似し、故障確率 F を推定する。保守サービスの管理目標である「予防保守による交換時期」を段階的に変化させ、上記①～③のステップを繰り返して交換部品数や所要時間を算出する。各段階での応力Sや故障Fの変化を比較することで、適切な管理目標を選択するのに役立つチャートを出力する。
  </dd>
