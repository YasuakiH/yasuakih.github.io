...
### 詳細な構造
#### ①未知パラメータから部品負荷の推定
最初の記事で推定した<a href="../article1/#未知パラメータ">未知パラメータ</a>をもとに、部品にかかる負荷を推定するための印刷ジョブを生成する。

部品にかかる負荷は、印刷ジョブによって運動する回転数や搬送距離として見積もった。

>  未知パラメータ<br/>
>  未知パラメータのうち、インク量は画質系の部品ライフに、また用紙の分量やサイズは搬送系の部品ライフに、それぞれ影響する可能性がある。
>  - インク関連
