...
### 結果
#### 交換部品数
交換時期を遅らせることによるトータルの部品交換数は低下傾向であった。交換理由の別では、「予防保守」(水色) は減り続け、一方「障害修理」(桃色) は増え続けた。故障の発生は確率的であり、経年が少ない場合でも故障は起こり、これが障害修理を生じさせる。特に故障がワイブル分布に従うような場合はかなり早期でも故障の可能性があり、交換時期を早めても初期故障を防ぎきれないことを表した。
