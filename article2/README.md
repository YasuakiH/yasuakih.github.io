...
### 詳細な構造
#### ①未知パラメータから部品負荷の推定
顧客の印刷機の使われ方を推定した<a href="../article1/#未知パラメータ">未知パラメータ</a>をもとに、部品に負荷をかけるための印刷ジョブを無作為に多数生成した。前述のように搬送系の部品に着目することから、部品にかかる負荷は、印刷ジョブによって輸送する用紙の長さ (送り方向) とジョブ長の積搬送距離として見積もった。未知パラメータから「印刷ジョブ長分布」と「用紙サイズ種類」からを無作為にサンプリングしたジョブ長と用紙サイズをもとに、紙送り方向の用紙の長さにジョブ長を乗じた搬送距離を、部品の運動による負荷 ΔT とした。
