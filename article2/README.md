...
### _応力_ - 部品の使われ方
最初の記事 <a href="../article1/">印刷機の使われ方</a> で、次にあげる「未知パラメータ」を推定した。これらの量は、応力-強度モデルにおいて部品に負荷をかける「応力」と見なせる。インク量は画質系の部品ライフに、また用紙量やサイズは搬送系の部品ライフにそれぞれ影響すると考える。そこで、本スタディでは、視覚的に理解しやすい後者の搬送系の部品 (物理的に用紙を輸送する) をターゲットに考える。
