...
#### ④管理目標値の最適値を探索
このステップでは、管理目標によって交換部品数や所要時間に与える影響をグラフィックで可視化する。上記①～③のステップから得る交換部品数や所要時間はバラつきがあるため、所定回数を繰り返して平均化した。交換時期の管理目標値を所定の範囲に段階的に設定し、それぞれの管理目標値について交換部品数や所要時間をグラフィックで可視化した。
