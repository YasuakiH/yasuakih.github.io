...
<dl>
  ...
  <dd>未知パラメータによって表された印刷機の使われ方をもとに、部品にかかる負荷を生成する。搬送系の部品であれば、印刷ジョブによって移動する用紙の搬送距離が負荷となる。未知パラメータから印刷ジョブ長の分布と用紙サイズの分布を取得し、無作為にサンプリングした印刷ジョブ長と用紙サイズを含む印刷ジョブを多数作成し、後続の②に出力する。</dd>
