...
#### 顧客の視点
管理目標を増加させると (交換時期を遅らせると) 「障害修理」による印刷機の停止時間が増加し、交換される部品数 (交換作業の回数) は減っても、障害修理によって業務が止まる時間は反対に増えることがわかった。印刷機は信頼性を重視することを考え合わせると、部品が故障するまで運転を続ける保守運用 (run-to-failure) 導入は難しいと考えられる。
