...
## 部品の故障モデル
本スタディでは、顧客による<a href="../article1/">印刷機の使われ方</a>が部品ライフに影響を及ぼすと考え、部品ライフを推定するために、確率的に故障が発生する [応力-強度モデル](https://en.wikipedia.org/wiki/Stress%E2%80%93strength_analysis) (Stress–strength model) を採用した。
理由として、一台一台の印刷機ごとに、停止時間 (ダウンタイム) と部品交換数 (コスト) とを最適化したいことと、予測結果を理解しやすいことがあげられる。
