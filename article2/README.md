...
<dl>
  ...
  <dl>
    <dt>部品強度 R</dt>
	<dd>故障モデルの部品強度 R は<a href="https://ja.wikipedia.org/wiki/%E3%83%AF%E3%82%A4%E3%83%96%E3%83%AB%E5%88%86%E5%B8%83">ワイブル分布</a>で近似した。ワイブル分布は修理しない部品ライフのモデル化によく使われ、2つの変数 (形状パラメータ、尺度パラメータ) のみで特徴付けられることから運用にも優れる。これらのパラメータはコマンドラインで与えた。もし保守サービスで交換された部品交換の実績があれば統計的に算出することもできる。</dd>
  </dl>
